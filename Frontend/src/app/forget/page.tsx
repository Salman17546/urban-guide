    ...
    <div className="flex justify-center items-center py-10">
      <div className="w-[450px] rounded-[40px] shadow-[0px_0px_75px_0px_#00000026]">
        ...
        <div className="bg-[#D7E5FF] rounded-b-[40px] pt-6">
            ...
            <input type="email" required name="email" placeholder="Your Email" className="bg-white text-black px-6 text-[16px] font-semi w-full h-14 rounded-[20px] outline-none focus:border-[#fff] opacity-100 placeholder-black mb-16" />
            <div className="flex justify-between items-center px-4 pb-20">
               <div className="w-[50%] text-left"><p className="text-[32px] font-heavy">Recover</p></div> 
