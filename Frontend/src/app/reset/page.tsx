  ...
  const handleSubmit = async (event: React.FormEvent<HTMLFormElement>) => {
    ...
    try {
      ...
      const response = await fetch('http://localhost:8000/change-password/', {
        ...
        body: JSON.stringify({confirm_new_password,old_password,new_password }),
      });
    ...
    <div className="flex justify-center items-center py-10">
      <div className="w-[450px] rounded-[40px] shadow-[0px_0px_75px_0px_#00000026]">
        ...
        <div className="bg-[#D7E5FF] rounded-b-[40px] pt-6">
            ...
            <input type="text" required name="old_password" placeholder="Current password" className="bg-white text-black px-6 text-[16px] font-semi w-full h-14 rounded-[20px] outline-none focus:border-[#fff] opacity-100 placeholder-black mb-5" />
            <input type="text" required name="new_password" placeholder="New password" className="bg-white text-black px-6 text-[16px] font-semi w-full h-14 rounded-[20px] outline-none focus:border-[#fff] opacity-100 placeholder-black mb-5" />
            <input type="text" required name="confirm_new_password" placeholder="Confirm new password" className="bg-white text-black px-6 text-[16px] font-semi w-full h-14 rounded-[20px] outline-none focus:border-[#fff] opacity-100 placeholder-black mb-8" />
            <div className="flex justify-between items-center px-4 pb-20">
               <div className="w-[50%] text-left"><p className="text-[32px] font-heavy">Reset</p></div> 
